# RailsAdmin config file. Generated on March 21, 2012 14:55
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ralencar', 'Admin']
  ...
  # config.excluded_models = [ContactForm, Job, Post]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [ContactForm, Job, Post]
